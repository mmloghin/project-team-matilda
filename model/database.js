...
con.connect(function (err) {
  ...
  let sql = 
  `DROP TABLE if exists books; CREATE TABLE books (id INT NOT NULL AUTO_INCREMENT, title VARCHAR(300), author VARCHAR(200), genre VARCHAR (200), pages VARCHAR(100), description VARCHAR(4000), image VARCHAR(200), price VARCHAR(100), featured BOOLEAN, PRIMARY KEY (id));
