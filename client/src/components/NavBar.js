  ...
  return (
    <div className="navigation flex items-center p-6">
      ...
      <div className="nav--bar ml-16 w-full block flex-grow flex items-center md:px-20 my-2 text-sm my-0 font-semibold font-color:black tracking-wide pb-1 py-2">
        ...
        <Link to="/signup"
          className="ml-72 border-b-2 border-transparent text-white bg-gradient-to-br from-blue-400 to-blue-600 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg text-sm px-10 py-2 text-center mr-2 mb-2"
        >
          Sign Up
        </Link>
